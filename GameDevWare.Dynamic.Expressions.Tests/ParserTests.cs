...
namespace GameDevWare.Dynamic.Expressions.Tests
{
	public class ParserTests
	{
		...
		[InlineData("a * b", TokenType.Multiplication)]
		[InlineData("a ** b", TokenType.Power)]
		[InlineData("a / b", TokenType.Division)]
		[InlineData("a % b", TokenType.Modulo)]
		[InlineData("a & b", TokenType.And)]
		[InlineData("a | b", TokenType.Or)]
		[InlineData("a ^ b", TokenType.Xor)]
		[InlineData("~a", TokenType.Complement)]
		[InlineData("a << b", TokenType.LeftShift)]
		[InlineData("a >> b", TokenType.RightShift)]
		[InlineData("a && b", TokenType.AndAlso)]
		[InlineData("a || b", TokenType.OrElse)]
		[InlineData("!a", TokenType.Not)]
		[InlineData("a > b", TokenType.GreaterThan)]
		[InlineData("a >= b", TokenType.GreaterThanOrEquals)]
		[InlineData("a < b", TokenType.LesserThan)]
		[InlineData("a <= b", TokenType.LesserThanOrEquals)]
		[InlineData("a == b", TokenType.EqualsTo)]
		[InlineData("a != b", TokenType.NotEqualsTo)]
		...
		[InlineData("a.b / c", TokenType.Division)]
		[InlineData("a.b << c", TokenType.LeftShift)]
		[InlineData("a.b >= c", TokenType.GreaterThanOrEquals)]
		[InlineData("a.b == c", TokenType.EqualsTo)]
		...
		[Theory]
		[InlineData("System.Func<A> < 1", 3, TokenType.LesserThan)]
		[InlineData("System<A>.Func<B,C>", 5, TokenType.Resolve)]
		[InlineData("MeMethod<A,B,C>()", 4, TokenType.Call)]
		[InlineData("MeMythod<Type1<Type2<B, C>, D, E, F>>() != 0", 8, TokenType.NotEqualsTo)]
