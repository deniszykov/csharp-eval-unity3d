...
{
	/// <summary>
	///     <see cref="ITypeResolver" /> which allows any public (<see cref="Type.IsPublic" />) type from specified
	///     <see cref="Assembly" />(or multiple <see cref="Assembly" />.
	/// </summary>
	public sealed class AssemblyTypeResolver : KnownTypeResolver
	{
		...
		public AssemblyTypeResolver(IEnumerable<Assembly> assemblies)
			: this(assemblies, default(ITypeResolver))
		{
		}
		/// <summary>
		///     Creates new <see cref="AssemblyTypeResolver" /> from list of assemblies.
