...
namespace GameDevWare.Dynamic.Expressions.CSharp
{
	...
	{
		/// <summary>
		/// Default value of "checked scope" parameter for <see cref="ParseFunc{ResultT}"/> and <see cref="Evaluate{ResultT}"/> methods.
		/// </summary>
		public const bool DEFAULT_CHECKED_SCOPE = true;
		/// <summary>
		/// Default name of first argument for <see cref="ParseFunc{Arg1,ResultT}"/> and <see cref="Evaluate{Arg1,ResultT}"/> methods.
		/// </summary>
		public const string ARG1_DEFAULT_NAME = "arg1";
		/// <summary>
		/// Default name of second argument for <see cref="ParseFunc{Arg1,Arg2,ResultT}"/> and <see cref="Evaluate{Arg1,Arg2,ResultT}"/> methods.
		/// </summary>
		public const string ARG2_DEFAULT_NAME = "arg2";
		/// <summary>
		/// Default name of third argument for <see cref="ParseFunc{Arg1,Arg2,Arg3,ResultT}"/> and <see cref="Evaluate{Arg1,Arg2,Arg3,ResultT}"/> methods.
		/// </summary>
		public const string ARG3_DEFAULT_NAME = "arg3";
		/// <summary>
		/// Default name of fourth argument for <see cref="ParseFunc{Arg1,Arg2,Arg3,Arg4,ResultT}"/> and <see cref="Evaluate{Arg1,Arg2,Arg3,Arg4,ResultT}"/> methods.
		/// </summary>
