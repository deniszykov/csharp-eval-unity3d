...
namespace GameDevWare.Dynamic.Expressions
{
	...
	public class ArgumentsTree : IDictionary<string, SyntaxTreeNode>
	{
		...
		/// </summary>
		public ICollection<SyntaxTreeNode> Values => this.innerDictionary.Values;
		/// <summary>
		...
		bool ICollection<KeyValuePair<string, SyntaxTreeNode>>.IsReadOnly => ((ICollection<KeyValuePair<string, SyntaxTreeNode>>)this.innerDictionary).IsReadOnly;
